                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h1 class="h4 text-gray-900 mb-4">Kodeku <?=lang('Auth.register')?></h1>
                                    </div>
                                    ...
                                    <form action="<?= route_to('register') ?>" method="post" class="user">
                                        <?= csrf_field() ?>
                                        <input type="hidden" name="user_image" value="default.png">
                                        <div class="form-group">
                                            ...
                                            <small id="emailHelp" class="form-text text-muted">Kami tidak pernah membagikan email kepada siapapun.</small>
                                        </div>
